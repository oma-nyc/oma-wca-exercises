...
- [IBM watsonx Code Assistant: Prompting Guide](#ibm-watsonx-code-assistant-prompting-guide)
  - [Table of Contents](#table-of-contents)
  - [A primer on Prompt Engineering](#a-primer-on-prompt-engineering)
    - [Why this matters](#why-this-matters)
    - [Where the magic happens (You, the Prompt Whisperer)](#where-the-magic-happens-you-the-prompt-whisperer)
    - [Hard Prompting](#hard-prompting)
    - [Soft Prompting](#soft-prompting)
    - [The Punchline](#the-punchline)
  - [Here are some simple ways to enhance your experience👇](#here-are-some-simple-ways-to-enhance-your-experience)
    - [Use personas or role names to provide context](#use-personas-or-role-names-to-provide-context)
    - [More examples](#more-examples)
      - [Terraform module](#terraform-module)
      - [Python ETL script](#python-etl-script)
      - [Security review](#security-review)
      - [Postgres tuning](#postgres-tuning)
    - [Generating API version specific code](#generating-api-version-specific-code)
    - [Encapsulate separate contexts into separate chats](#encapsulate-separate-contexts-into-separate-chats)
    - [Avoid "Give me a rock / No, not that rock"](#avoid-give-me-a-rock--no-not-that-rock)
      - [Kubernetes manifest](#kubernetes-manifest)
      - [Java unit test](#java-unit-test)
      - [PowerShell backup script](#powershell-backup-script)
    - [Also good to remember](#also-good-to-remember)
  - [Test your knowledge so far](#test-your-knowledge-so-far)
  - [Authors](#authors)
...
<img src="images/soft-prompt-example.png" width="335" align="bottom" alt="code-screenshot" hspace="20" vspace="20">
...
### Avoid "Give me a rock / No, not that rock"
...
This guide was produced by proud IBM Client Engineers Adam Hayden, Alex Swart, Boris Acha, Gerald Trotman, Jim Ryan, and Pete Nuwayser April 17-23, 2025. If you would like to contribute, please get in touch with one of us.
